...
namespace Accounting.Migrations
{
    ...
    [Migration("20250325114224_Add_ImportRecord")]
    partial class Add_ImportRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting.Imports.ImportRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Accounting.Imports.ImportRecordItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Accounting.Imports.ImportRecord", b =>
                {
                    ...
                    b.OwnsOne("Accounting.Imports.ImportChannel", "Channel", b1 =>
                        {
                            b1.Property<long>("ImportRecordId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("ImportRecordId");

                            b1.ToTable("ImportRecords");
            ...
            modelBuilder.Entity("Accounting.Imports.ImportRecordItem", b =>
                {
                    b.HasOne("Accounting.Imports.ImportRecord", null)
                        .WithMany("Items")
